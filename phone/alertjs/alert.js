...
/*
	showMsg:function(obj){
		var subhtml='<div id="alert_dialog_show_msg_box" style=" overflow:hidden;height:100px;width:200px;margin:15% auto;"><div class="sweet-overlay" tabIndex="-1" style=" background-color:#000; opacity:0.4; position: fixed; left: 0; right: 0; top: 0; bottom: 0; z-index:1000;"></div><div id="alert_show_3" style="height:100px; width:200px; background-color:#fff; color:#000; border-radius:8px;font-size:20px; text-align:center;z-index:2000;position:absolute;"><p style="font-size:14px; margin-top:50px;">'+obj+'</p><input name="button" onclick="closedShowMsg()" type="R" value="纭" style=" width:60px; height:30px; line-height:30px;"  /></div></div>';
		$("body").append(subhtml);
	},*/
    ...
    showMsg:function(obj){
        ...
        <div id="alert_show_3" style="height:100px; width:200px; background-color:#fff; color:#000; border-radius:8px;font-size:20px; text-align:center;z-index:2000;position:absolute;">
        ...
        <div class="button-holder">
            ...
            <label for="radio-1-2"></label><br />
            <input type="radio" id="radio-1-3" name="radio-1-set" class="regular-radio" />
            <label for="radio-1-3"></label><br />
            <input type="radio" id="radio-1-4" name="radio-1-set" class="regular-radio" />
            <label for="radio-1-4"></label><br />
        </div>
    </div>
        <input name="button" onclick="closedShowMsg()" type="button" value="确认" style=" width:60px; height:30px; line-height:30px;"  />
        </div>
        </div>';
        $("body").append(subhtml);
    },
